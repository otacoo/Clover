...
import static org.otacoo.chan.utils.AndroidUtils.hideKeyboard;
...
public class Toolbar extends LinearLayout implements
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyle) {
        ...
        arrowMenuView.setColorFilter(org.otacoo.chan.utils.AndroidUtils.getAttrColor(getContext(), R.attr.ui_text_color));
