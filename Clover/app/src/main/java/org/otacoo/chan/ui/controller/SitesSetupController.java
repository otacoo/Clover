...
import org.otacoo.chan.core.presenter.SitesSetupPresenter.SiteBoardCount;
...
public class SitesSetupController extends StyledToolbarNavigationController implements
    ...
    private class SitesAdapter extends RecyclerView.Adapter<SiteCell> {
        ...
        public void onBindViewHolder(@NonNull SiteCell holder, int position) {
            ...
            if (boards == 0 && !ChanSettings.setupSitesBoardsHintShown.get()) {
                ChanSettings.setupSitesBoardsHintShown.set(true);
    ...
    private class SiteCell extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public SiteCell(View itemView) {
            ...
            itemView.findViewById(R.id.remove_site).setVisibility(View.GONE);
            ImageView reorder = itemView.findViewById(R.id.reorder);

            // Setup views
            itemView.setOnClickListener(this);

            Drawable drawable = ContextCompat.getDrawable(context, R.drawable.ic_reorder_black_24dp).mutate();
