...
public class ToolbarMenuView extends LinearLayout {
    ...
    private void setupMenuViews() {
        ...
        menu.items.sort(Comparator.comparingInt(a -> a.order));
        ...
        for (ToolbarMenuItem item : menu.items) {
            ...
            imageView.setColorFilter(org.otacoo.chan.utils.AndroidUtils.getAttrColor(getContext(), R.attr.ui_text_color));
